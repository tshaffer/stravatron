...
function loadAthletes(dbServices) {
  ...
  return function (dispatch) {
    ...
    getAthletesPromise.then(athletes => {
      ...
      // dbServices.addAthlete("2843574", "", "Dad", "Ted", "Shaffer", "shaffer.family@gmail.com");
      // dbServices.addAthlete("7085811", "", "Mom", "Lori", "Shaffer", "loriashaffer@gmail.com");
      // dbServices.addMap("Santa Cruz", "mapbox://styles/tedshaffer/citagbl4b000h2iqbkgub0t26");
